...
// T can be anything but T is the convention
  // returns same type as input/paramater type
...
// IF working in a tsx file, use trailing comma after T --- <T,>
//Multiple Types ? use this sorta syntax:
